...
We as members, contributors, and leaders pledge to make participation in the aiREST community a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, caste, color, religion, or sexual identity and orientation.
...
- Focusing on what is best for the community and the standard, not just individual preferences
...
This Code of Conduct applies within all community spaces — including GitHub issues, pull requests, discussions, and any other forums where the project is represented — and also applies when an individual is officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the project maintainers by contacting the [repository owner](https://github.com/gustaveherbst/airest) through GitHub (profile contact or repository discussion), or by opening a private communication channel agreed with maintainers.
